...
// const trimmedEmail = lowerEmail.trim(); // getting rid of whitespace
...
console.log(announcement.replace("door", "gate")); // only replace the first occurence
console.log(announcement.replaceAll("door", "gate")); // replacing all 'door's

console.log(announcement.replace(/door/g, "gate")); //replace methods are case sensitive
...
console.log("Jonas Park".split(" "));

const [firstName, lastName] = "Jonas Park".split(" ");
...
const capitalizeName = function (name) {
  ...
  for (const n of names) {
    ...
    namesUpper.push(n.replace(n[0], n[0].toUpperCase())); //another way of doing it
  }
  console.log(namesUpper.join(" "));
};

capitalizeName("jessica ann smith davis");
capitalizeName("sejin park");

//Padding
const message = "Go to gate 23!";
console.log(message.padStart(20, "+").padEnd(30, "+")); //length of the entire string becomes 25
...
console.log(maskCreditCard(2343958737539458));
console.log(maskCreditCard("0239482304982340398"));
